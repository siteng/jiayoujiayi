...
Version: 1.0
*/
class WPJAM_301Redirect extends WPJAM_Model {
...
add_action('template_redirect',	['WPJAM_301Redirect', 'on_template_redirect'], 99);

if(is_admin() && (!is_multisite() || !is_network_admin())){
	wpjam_add_basic_sub_page('301-redirects', [
		'menu_title'	=> '301跳转',
		'function'		=> 'list',
		'load_callback'	=> ['WPJAM_301Redirect', 'load_list_table_page'],
